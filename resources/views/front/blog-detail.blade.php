          ...
          <div class="blog-details-full">
                ...
                <div class="col-md-6 order-md-first order-last">
                  <div class="left-a">
                    @if ($blog->user_id != null)
                      <span class="img"><img src="{{ url('web/') }}/assets/img/b-auth.png" alt="auth"></span>
            ...
            <div class="blog-author-section mt-20 mb-60">
              ...
              <div class="content-auth">
                ...
                <p>Dr. Jaya Balan is a renowned gynaecologist and fertility specialist with more than 20 years of experience in this field. He practices at Pantai Hospital Ipoh and he is also a Visiting Consultant at LPPKN (government clinic for fertility and family health) and Seri Manjung Specialist Clinic.</p>
              </div>
            </div>
