        ...
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
          <div class="collapse navbar-collapse" id="topnav-menu-content">
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="{{ aurl('treatments') }}" id="topnav-dashboard"
                  role="button">
                  <i data-feather="file-text"></i><span data-key="t-dashboards">Treatments</span>
                </a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle arrow-none" href="{{ aurl('testimonials') }}"
                  id="topnav-dashboard" role="button">
                  <i data-feather="file-text"></i><span data-key="t-dashboards">Testimonials</span>
                </a>
              </li>
              <li class="nav-item dropdown">
